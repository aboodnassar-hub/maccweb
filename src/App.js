...
const ApiService = {
  baseUrl: 'http://127.0.0.1:8000', // Matches your fastapi auth.py
...
const AuthScreen = ({ onLogin, lang, t, setLang }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // --- NOTE: To use REAL BACKEND, uncomment this block and comment out the simulation ---
      /*
      let user;
      if (isLogin) {
  ...
  return (
    <div dir={lang === 'ar' ? 'rtl' : 'ltr'} className="min-h-screen flex bg-slate-50 overflow-hidden">
      ...
      {/* LEFT PANEL - BRAND & OVERVIEW (Desktop Only) */}
      <div className="hidden lg:flex w-1/2 bg-gradient-to-br from-blue-700 to-indigo-900 relative overflow-hidden flex-col justify-between p-16 text-white">
        ...
        <div className="absolute top-0 left-0 w-full h-full opacity-20 pointer-events-none">
             ...
             <div className="absolute top-[40%] left-[40%] w-64 h-64 rounded-full bg-white blur-[80px] opacity-30 animate-pulse delay-1000"></div>
        </div>
        ...
        <div className="relative z-10">
          ...
          <div className="space-y-6 mt-12">
            <h1 className="text-4xl md:text-5xl font-extrabold leading-tight max-w-lg tracking-tight">
              {t('companyTitle')}
            </h1>
        ...
        <div className="relative z-10 text-xs text-blue-200/60 font-medium tracking-widest uppercase mt-12">
          © 2025 Macc Accounting Systems
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 relative bg-white">
        ...
        <div className="absolute top-6 end-6 z-20">
            <button 
                ...
                className="flex items-center gap-2 px-4 py-2 rounded-full bg-white border border-slate-200 text-slate-600 hover:bg-slate-50 transition-all text-sm font-medium shadow-sm hover:shadow-md"
            >
                <Globe size={16} />
        ...
        <div className="max-w-md w-full">
          <div className="mb-10 text-center lg:text-start">
             <div className="lg:hidden w-14 h-14 bg-blue-600 rounded-2xl flex items-center justify-center text-white font-bold text-2xl mx-auto mb-6 shadow-blue-200 shadow-xl">M</div>
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <input 
                    type="text" 
                    required 
                    className="w-full ps-12 pe-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:bg-white focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all font-medium"
          ...
          <div className="mt-10 pt-6 border-t border-slate-100 text-center">
            <p className="text-sm text-slate-500 font-medium">
              ...
              <button 
                ...
                className="text-blue-600 font-bold hover:text-blue-800 hover:underline ms-2 transition-colors"
              >
...
// I've updated the data to include 'nameKey' which maps to the dictionary
const ACCOUNTS_DATA = [
...
export default function App() {
  const [activeView, setActiveView] = useState('dashboard'); // Default to dashboard after login
  ...
  return (
    // 'dir' attribute handles RTL layout automatically with Tailwind logical properties
    <div dir={lang === 'ar' ? 'rtl' : 'ltr'} className="flex h-screen bg-slate-100 font-sans text-slate-900">
      
      {/* SIDEBAR */}
      <div className="w-64 bg-white border-e border-slate-200 flex flex-col shadow-sm z-20">
        ...
        <div className="p-4 border-t border-slate-100 space-y-3">
          ...
          <button 
            onClick={() => setLang(lang === 'en' ? 'ar' : 'en')}
            className="flex items-center justify-center gap-2 w-full p-2 rounded-lg border border-slate-200 text-slate-600 hover:bg-slate-50 transition-colors text-sm font-medium"
          >
            <Globe size={16} />
            {lang === 'en' ? 'العربية' : 'English'}
          </button>
          ...
          <button 
            ...
            className="flex items-center justify-center gap-2 w-full p-2 rounded-lg border border-red-100 text-red-600 hover:bg-red-50 transition-colors text-sm font-medium"
          >
            <LogOut size={16} />
            {t('logout')}
          </button>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-8 shadow-sm z-10">
          <div>
            ...
            <p className="text-xs text-slate-400 font-medium">{t('financialYear')}</p>
          </div>
          <div className="flex items-center gap-4">
