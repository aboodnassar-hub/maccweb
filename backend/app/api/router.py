...
from backend.app.modules.purchases.router import router as purchases_router
...
api_router.include_router(system_admin_router, prefix="/system-admin", tags=["system-admin"])
